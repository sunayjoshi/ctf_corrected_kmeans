...
with open("pickles/l2-" + str(snr) + "-labels" + effects + ".pickle", "rb") as f:               
    l2_labels = pickle.load(f)                                                  
with open("pickles/wemd-" + str(snr) + "-labels" + effects + ".pickle", "rb") as f:             
...
def save_figure(fig, name):
    ...
    fig.savefig(filename, dpi=DPI, bbox_inches='tight', format='png') # pdf?
